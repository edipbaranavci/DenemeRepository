...
import 'package:api_deneme/models/user.dart';
...
class _UserInfoState extends State<UserInfo> {
  ...
  // BİLGİ : <User> EKLENEREK HATA GİDERİLDİ. YAPMAZSAN VERİ TİPİ DÖNÜŞÜMÜNDE HATA OLUR
...
//** http ve dio denemesi karşılaştırmak için eklendi */
    ...
    if (response.statusCode == 200) {
      setState(() {
        user = User.fromJson(json.decode(response
            .toString())); //response.toString() yaparak body işlevinden kurtuldum hata kalktı
      });
      return user;
    } else {
      throw Exception('failed in fetchUser');
